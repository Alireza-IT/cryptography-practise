...
int main(int argc,char **argv) {
    ...
    //allocate the contexr
        ...
        if(1!=HMAC_Init_ex(hmac_ctx,KEY,strlen(KEY),EVP_sha512(),NULL))//pointer to memory where the secret is store and second one size of buffer that this data is saved 
           handleErrors();
...
//gcc -o hmax-512.exe hmax_sha512.c -lcrypto 
// ./hmac.exe ../random.c
//openssl dgst -sha512 -hmac asdfsdfsafsdf ../random.c
